...
using exclusively the validated Phase 1 cleaned datasets:
  - ../Phase-1/data/cleaned/Social_Engine_Users_Cleaned.csv
  - ../Phase-1/data/cleaned/Social_Engine_Posts_Cleaned.csv
...
def get_paths():
    ...
    phase1_root = os.path.abspath(os.path.join(project_root, "..", "Phase-1"))
    return {
        "db": os.path.join(project_root, "data", "data_vortex.db"),
        "schema": os.path.join(project_root, "sql", "01_schema.sql"),
        "users_csv": os.path.join(phase1_root, "data", "cleaned", "Social_Engine_Users_Cleaned.csv"),
        "posts_csv": os.path.join(phase1_root, "data", "cleaned", "Social_Engine_Posts_Cleaned.csv"),
    }
